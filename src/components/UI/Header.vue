<template>
    <header class="px-4 bg-slate-800 shadow-md ">
        <div
            ...
            <div
                class="min-h-full py-2" @click="home">
                <h1 class="tracking-wide text-4xl font-black text-white py-2">
                    SkyBudget<span class="font-mono text-slate-500">™</span>
                </h1>
            </div>
            <div v-if="!userStore.getLoggedin" class="flex align-middle min-h-full">
                <div class="toggle-login" @click="login"><p class="my-auto">Log In</p></div>
