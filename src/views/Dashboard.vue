<template>
  <div class="flex items-center justify-between mt-16">
    <div class="ml-[25rem]">
      <font-awesome-icon
        class="absolute text-xl text-[#ADAFAF] top-[85px] left-[730px]"
      ...
      <input
        ...
        name="search"
        id="search"
        class="bg-[#F6F6F6] border-2 rounded-2xl h-8 indent-8 outline-0 focus:border-[#ADAFAF]"
        size="60"
        placeholder="Search"
      />
    </div>
